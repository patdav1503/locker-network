...
const namespace = 'org.locker.mynetwork';
const assetType = 'IntegerLocker';
...
describe('#' + namespace, () => {
    ...
    beforeEach(async () => {
        ...
        asset2.errorCode = 5000;
        asset2.returnValue = -1;
    ...
    it('Alice can read only her assets', async () => {
    ...
    it('Bob can read only his assets', async () => {
